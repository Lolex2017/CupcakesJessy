			...
			<header>
				...
				<nav>
					<ul>
						...
						<li class="actual"><a href="eventos.php">Eventos</a></li>
		...
		<div id="bloqueDer">
			<div id="contenido" class="pagina-interna">
				<section id="eventos">
					<article>
						<header>
							<img src="img/eventos_1_1.jpg" alt="Eventos">
							<hgroup>
								<h1>Eventos</h1>
						...
						<img src="img/evento_cumpleanos_1_1.JPG" alt="Cumpleano" >
						<h3>Cumpleaños</h3>
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor 
						   incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud 
						   exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
						<p>Duis aute iruredolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.
						   Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt 
						   mollit anim id est laborum.</p>

						<hr/>

						<img src="img/evento_cupcakes_1_1.jpg" alt="Cupcake" >
						<h3>Cupcakes</h3>
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor 
						   incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud 
						   exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
						...
						<img src="img/evento_tortas_1_1.jpg" alt="Torta" >
						<h3>Pasteles</h3>
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor 
						   incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud 
						   exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
